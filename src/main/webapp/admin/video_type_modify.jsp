                    ...
                    <div style="margin-top: 10px">
                        <form class="form-horizontal" action="/admin/videoType" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="请输入视频类型名称" value="${videoType.name}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" style="resize: none" id="description" name="description" rows="3" placeholder="留下点什么吧...">${videoType.description}</textarea>
                                </div>
                            </div>
